        ...
        <div className="relative bg-gray-100 h-[140px] sm:h-[280px] flex items-center justify-center p-2">
          ...
          >
            ...
            <button
              ...
              className="w-8 h-8 md:w-10 sm:w-5 sm:h-5 md:h-10 text-xs md:text-base bg-white rounded-full flex items-center justify-center shadow hover:bg-black hover:text-white transition"
            >
              <FaShoppingCart />
            </button>
