...
const featureproducts = productCollection?.products ?? [];
            ...
            >
              ...
              <div className="relative h-[180px] sm:h-[180px] md:h-[260px] lg:h-[280px] bg-ring/5 flex items-center justify-center">
                ...
                >
                  ...
                  <button
                    ...
                    className="w-5 h-5 sm:w-5 sm:h-5 md:w-10 md:h-10 bg-background rounded-full flex items-center justify-center shadow hover:bg-foreground hover:text-text-secondary transition"
                  >
                    <FaShoppingCart />
                  </button>
              ...
              <Link href={`/products/${item.slug}`}>
                ...
                <div className="p-3 md:p-4">
                  ...
                  <div className="flex gap-1 text-yellow-500 mt-0 text-sm">
                    {[...Array(5)].map((_, index) => (
                      <FaStar key={index} />
                    ))}
                  </div>
